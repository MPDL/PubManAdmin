export const props = {
    auth_base_url: "https://dev.inge.mpdl.mpg.de/auth",
    auth_token_url: "https://dev.inge.mpdl.mpg.de/auth/token",
    auth_users_url: "https://dev.inge.mpdl.mpg.de/auth/users",
    // auth_base_url: "http://localhost:8080/auth",
    // auth_token_url: "http://localhost:8080/auth/token",
